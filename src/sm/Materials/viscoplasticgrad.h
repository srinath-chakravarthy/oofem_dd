...
#ifndef viscoplasticgrad_h
#define viscoplasticgrad_h
...
///@name Input fields for ViscoplasticGrad
//@{
#define _IFT_ViscoPlasticGrad_Name "viscoplasticgrad"
#define _IFT_ViscoPlasticGrad_sig0 "sig0"
#define _IFT_ViscoPlasticGrad_pow "pow"
#define _IFT_ViscoPlasticGrad_m "m"
#define _IFT_ViscoPlasticGrad_cp "cp"
#define _IFT_ViscoPlasticGrad_lobs "lobs"
//@}
...
/**
 * This class implements an isotropic viscoplasticgrad material
 * with Mises yield condition, associated flow rule, with conventional 
 * mechanism based strain gradient plasticity
 * It follows from Needelman Asaro ViscoplasticGrad Model and then 
 */
class ViscoPlasticGrad : public StructuralMaterial
{
protected:
...
public:
    ViscoPlasticGrad(int n, Domain * d);
    virtual ~ViscoPlasticGrad();

    void performPlasticityReturn(GaussPoint *gp, const FloatArray &totalStrain);

    double computeXita(GaussPoint *gp);
    ...
    virtual const char *giveInputRecordName() const { return _IFT_ViscoPlasticGrad_Name; }
    virtual const char *giveClassName() const { return "ViscoPlasticGrad"; }
...
class ViscoPlasticGradStatus : public StructuralMaterialStatus
{
protected:
...
public:
    ViscoPlasticGradStatus(int n, Domain * d, GaussPoint * g);
    virtual ~ViscoPlasticGradStatus();
    ...
    virtual const char *giveClassName() const { return "ViscoPlasticGradStatus"; }
};
} // end namespace oofem
#endif // viscoplasticgrad_h
