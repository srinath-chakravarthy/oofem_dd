...
#ifndef DDlinearstatic_h
#define DDlinearstatic_h
 ...
 * - Managing time steps.
 */
class DDLinearStatic : public StructuralEngngModel
{
protected:
...
public:
    ...
    // identification
    virtual const char *giveInputRecordName() const { return _IFT_DDLinearStatic_Name; }
    virtual const char *giveClassName() const { return "DDLinearStatic"; }
