...
void
PlaneStressElement :: computegradmatrixAt(GaussPoint *gp, FloatMatrix &answer)
// Return the [4x2] Linear interpolation components of the B matix 
// Evaluated at gp 
// [dN_1/dx dN_2/dx dN_3/dx dN_4/dx
//  dN_1/dy dN_2/dy dN_3/dy dN_4/dy] Transpose
// For plane problems the dn_i/dz terms are zero 
{
    FEInterpolation *interp = this->giveInterpolation();
    FloatMatrix dN;
    interp->evaldNdx( dN, gp->giveNaturalCoordinates(), FEIElementGeometryWrapper(this) );
}
...
void
PlaneStrainElement :: computegradmatrixAt(GaussPoint *gp, FloatMatrix &answer)
// Return the [4x2] Linear interpolation components of the B matix 
// Evaluated at gp 
// [dN_1/dx dN_2/dx dN_3/dx dN_4/dx
//  dN_1/dy dN_2/dy dN_3/dy dN_4/dy] Transpose
